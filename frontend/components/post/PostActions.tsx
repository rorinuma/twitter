...
export default function PostActions({
  ...
  useClickOutside([permissionsModalRef, permissionsButtonRef], () => {
    setPermissionsModalVisible(false);
  });
      ...
      >
        {!replyTo && (
          <div className="relative mb-2 ml-2 ">
            ...
            {permissionsModalVisible && (
              <div className="max-xs:fixed max-xs:inset-0 max-xs:bg-blue-overlay bg-background">
                <div
